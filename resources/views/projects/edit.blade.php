    ...
    <div class="card border-0 shadow-sm rounded-3">
        ...
        <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark">Edit Project: {{ $project->project_code }}</h5>
            </div>
            ...
            <div class="mb-5">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="project_code" class="form-control" value="{{ $project->project_code }}" readonly>
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="customer" class="form-select">
                            ...
                            <option value="{{ $cust->customer_code }}" {{ $project->customer == $cust->customer_code ? 'selected' : '' }}>{{ $cust->customer_code }} | {{ $cust->customer_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-3">
                        ...
                        <select name="category" class="form-select">
                            ...
                            <option value="{{ $cat->category_name }}" {{ $project->category == $cat->category_name ? 'selected' : '' }}>{{ $cat->category_code }} | {{ $cat->category_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <select name="pic_user_id" class="form-select">
                            ...
                            @foreach($users as $u)
                            <option value="{{ $u->id }}" {{ $project->pic_user_id == $u->id ? 'selected' : '' }}>{{ $u->full_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row g-3">
                    <div class="col-md-2">
                        <div class="date-card">
                            ...
                            <input type="date" name="die_go" class="form-control form-control-sm border-0 bg-light" value="{{ $project->die_go }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="date-card">
                            <label class="form-label-custom small text-muted">TO</label>
                            <input type="date" name="to" class="form-control form-control-sm border-0 bg-light" value="{{ $project->to }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="date-card">
                            <label class="form-label-custom small text-muted">PP1</label>
                            <input type="date" name="pp1" class="form-control form-control-sm border-0 bg-light" value="{{ $project->pp1 }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="date-card">
                            <label class="form-label-custom small text-muted">PP2</label>
                            <input type="date" name="pp2" class="form-control form-control-sm border-0 bg-light" value="{{ $project->pp2 }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="date-card">
                            <label class="form-label-custom small text-muted">PP3</label>
                            <input type="date" name="pp3" class="form-control form-control-sm border-0 bg-light" value="{{ $project->pp3 }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="date-card mass-pro-highlight">
                            <label class="form-label-custom small text-success">MASS PRO</label>
                            <input type="date" name="mass_pro" class="form-control form-control-sm bg-transparent" value="{{ $project->mass_pro }}">
                        </div>
                    </div>
                </div>
            </div>
