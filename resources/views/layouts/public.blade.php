    ...
    <script>
        const translations = {
            'en': {
                ...
                'section_tech': 'Tech Stack That I Use',
                'section_tech': 'Tech Stack That I Use',
                'nav_job_description': 'Job Description & Activity',
                'nav_obstacle_challenge': 'Obstacle & Challenge',
                'nav_education': 'Education',
                'nav_experience': 'Professional Experience',
                'section_jd': 'Job Description & Activity',
                'jd_descriptions': 'Job Descriptions',
                'jd_activities': 'Activity Jobs',
                'section_oc': 'Obstacle & Challenge',
                'oc_obstacles': 'Obstacles',
                'oc_challenges': 'Challenges',
            ...
            'id': {
                ...
                'nav_job_description': 'Deskripsi Pekerjaan & Aktivitas',
                'nav_obstacle_challenge': 'Hambatan & Tantangan',
                'nav_education': 'Pendidikan',
                'nav_experience': 'Pengalaman Kerja',
                'section_jd': 'Deskripsi Pekerjaan & Aktivitas',
                'jd_descriptions': 'Deskripsi Pekerjaan',
                'jd_activities': 'Aktivitas Pekerjaan',
                'section_oc': 'Hambatan & Tantangan',
                'oc_obstacles': 'Hambatan',
                'oc_challenges': 'Tantangan',
